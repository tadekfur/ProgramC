...
void DbManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->dbConnectionError((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 1: _t->orderAdded(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (DbManager::*)(const QString & )>(_a, &DbManager::dbConnectionError, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (DbManager::*)()>(_a, &DbManager::orderAdded, 1))
            return;
    }
}
...
// SIGNAL 0
void DbManager::dbConnectionError(const QString & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void DbManager::orderAdded()
{
